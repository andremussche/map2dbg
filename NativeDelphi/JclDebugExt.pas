...
// Last modified: $Date:2009-02-27 13:27:02$
...
type
  ...
  public
    FSegmentNames: array of TJclBinDbgSegmentCache;
...
type
  ...
  public
    ...
    function GetInfoSourceClassList : TList;
  end;
  ...
  public
    ...
    function GetScanner : TJclMapScanner;
  end;
...
begin
  ...
  try
    ...
    L2 := 0;
    L3 := 0;
    for I := 0 to Length(FSegmentClasses) - 1 do
    begin
      WriteValueOfs(FSegmentClasses[I].Segment, L1);
      WriteValueOfs(FSegmentClasses[I].VA, L2);
      WriteValueOfs(FSegmentClasses[I].Len, L3);
    end;
    WriteValue(MaxInt);
    //
...
begin
  ...
  begin
    ...
    begin
      ...
      SetLength(FSegmentNames, iCount+1);
      FSegmentNames[iCount].Segment := iSegment;
      FSegmentNames[iCount].Address := dAddress;
      FSegmentNames[iCount].Length  := iLength;
      inc(iCount);
    end;
  end;
...
function TJclDebugInfoList.GetInfoSourceClassList : TList;
begin
  Result := InfoSourceClassList;
end;
...
function TJclDebugInfoMap.GetScanner;
begin
  Result := FScanner;
end;
